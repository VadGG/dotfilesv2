...
function main.colors()
    return {
        ...
        -- selection_bg = '#2a283e',
        quick_select_label_bg = {Color = "#A1E8AF"},
        quick_select_label_fg = {Color = main_palette.base},
        quick_select_match_bg = {Color = "#f7f0f0"},
        quick_select_match_fg = {Color = main_palette.base},

        selection_bg = main_palette.highlight,
